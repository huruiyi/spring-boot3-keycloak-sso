...
> 🤖 **AI 生成项目** - 本项目由 Kiro AI 助手协助开发，旨在提供完整的 Keycloak SSO/SLO 学习示例
...
本项目由 **Kiro AI** 助手协助开发，具有以下特点：
- **完整性**: 从需求分析到代码实现的全流程覆盖
- **教学性**: 每个关键步骤都有详细说明
- **实用性**: 可直接运行的完整示例
- **可扩展性**: 易于理解和修改的代码结构
...
- Spring Boot 开发者
- 需要集成 Keycloak 的项目团队
- 学习 OAuth 2.0 / OpenID Connect 的开发者
- 希望了解单点登录实现原理的技术人员
...
本项目展示了 AI 辅助开发的优势：
- **快速原型**: 从概念到可运行代码的快速实现
- **最佳实践**: 遵循 Spring Security 和 Keycloak 的最佳实践
- **完整文档**: 详细的使用说明和故障排查指南
- **教学导向**: 适合学习和理解 SSO/SLO 实现原理

## 贡献

欢迎提交 Issue 和 Pull Request！

如果你觉得这个项目对学习 Keycloak 有帮助，请给个 ⭐️ Star！
...
1. **先理解概念**: 阅读文档中的架构说明和工作原理
2. **动手实践**: 按照快速开始指南搭建环境
3. **查看日志**: 运行时观察控制台输出，理解认证流程
4. **调试测试**: 使用调试信息面板了解会话状态
5. **扩展功能**: 基于现有代码添加自己的业务逻辑

---

**注意**: 本项目仅用于学习和演示目的，生产环境使用前请进行充分的安全评估和测试。

> 🚀 **快速开始**: 如果你是第一次接触 Keycloak，建议先阅读 [快速开始](#快速开始) 部分，然后按步骤操作。整个过程大约需要 30 分钟即可看到效果！
